...
abstract class $SongCopyWith<$Res> {
  ...
  @useResult
  $Res call({String image, String number, String tag});
}
...
class _$SongImpl with DiagnosticableTreeMixin implements _Song {
  _$SongImpl({required this.image, required this.number, required this.tag});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Song(image: $image, number: $number, tag: $tag)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, image, number, tag);
...
abstract class _Song implements Song {
  factory _Song(
      ...
      required final String tag}) = _$SongImpl;
